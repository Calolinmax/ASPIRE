# Code block 0
# =============================================================================
# ASPIRE Primitive API 任务代码示例 - Wipe 擦拭任务
# =============================================================================
# 说明：
#   此代码展示了如何使用 Primitive API 完成 Wipe 擦拭任务。
...
#             point_prompt_molmo(), mask_to_world_points()
#   - 运动类: solve_ik(), move_to_joints(), interpolate_segment()
