...
用法:
    ...
    # 终端 2：运行验证
    MUJOCO_GL=egl /home/stouching/anaconda3/envs/ASPIRE/bin/python scripts/archive/cgn_verify_steps.py
"""
import os
import sys
import numpy as np
...
from aspire.perception.vision_client import grasp_cgn, segment_sam3_text_prompt
from aspire.api.primitives_capx import cgn_to_gripper, PrimitiveContextCapx
