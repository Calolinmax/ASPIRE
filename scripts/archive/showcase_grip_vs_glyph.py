...
用法: MUJOCO_GL=glfw python scripts/archive/showcase_grip_vs_glyph.py [seed]
"""
import os
import sys
import time
...
from aspire.api.primitives_capx import PrimitiveContextCapx, cgn_to_gripper, PIPER_MAX_WIDTH
