...
任务代码（scripts/tests/demo_stack_taskcode.py）改编自 ASPIRE 官方公开示例
...
运行（AGENTS.md：必须 ASPIRE 环境（py3.12）；无头服务器用 EGL）：
    ...
    MUJOCO_GL=egl /home/stouching/anaconda3/envs/ASPIRE/bin/python scripts/tests/demo_stack_dualcam.py
...
from aspire.engine.engine import ExecutionEngine
from aspire.evidence.trace import CATEGORIES
...
def main():
    ...
    from aspire.perception.vision_sam3 import warmup
    warmup()
