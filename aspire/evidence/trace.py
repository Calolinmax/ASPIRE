...
CATEGORIES = {
    ...
    "grasp_cgn": "detection",
    "draw_grasp_glyphs": "detection",  # 契约外 3D glyph 可视化（2026-08-06）
    # 规划 (Planning)
    "solve_ik": "planning",
    ...
    "plan_grasp": "grasping",
    "select_top_down_grasp": "grasping",
    # 控制调用 (Control)
    "move_to_pose": "control",
    "move_to_joints": "control",
    "move_to_joints_planned": "control",  # 契约外 RRT 避障（2026-08-06 用户指令③）
    "execute_legs_rrt": "control",        # 契约外 逐腿RRT+密化流式（2026-08-06 照抄参考）
    "set_gripper_ramp": "control",        # 契约外渐进夹爪（2026-08-06, 夹爪太快弹块）
}
